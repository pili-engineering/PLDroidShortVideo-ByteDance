...
import com.qiniu.pili.droid.shortvideo.demo.adapter.FragmentVPAdapter;
import com.qiniu.pili.droid.shortvideo.demo.fragment.contract.EffectContract;
import com.qiniu.pili.droid.shortvideo.demo.fragment.contract.ItemGetContract;
import com.qiniu.pili.droid.shortvideo.demo.fragment.contract.presenter.EffectPresenter;
...
import com.qiniu.pili.droid.shortvideo.demo.view.ProgressBar;
...
public class EffectFragment extends BaseFeatureFragment<EffectContract.Presenter, EffectFragment.IEffectCallback>
        implements RecordView.OnCloseListener, MakeupOptionFragment.IMakeupOptionCallback, EffectContract.View, ItemGetContract.View, View.OnClickListener {
    ...
    public void onClose() {
        ...
        for (Fragment f : mFragmentList) {
            if (f instanceof RecordView.OnCloseListener) {
                ((RecordView.OnCloseListener) f).onClose();
            }
        }
    }
    ...
    private void closeBeautyFace() {
        ...
        // 调用子 Fragment 关闭 UI
        RecordView.OnCloseListener listener = (RecordView.OnCloseListener) mFragmentList.get(POSITION_BEAUTY);
        listener.onClose();
    }
    ...
    private void closeBeautyReshape() {
        ...
        RecordView.OnCloseListener listener = (RecordView.OnCloseListener) mFragmentList.get(POSITION_RESHAPE);
        listener.onClose();
    }
    ...
    private void closeBeautyBody() {
        ...
        updateComposerNodes();
        // 调用子 Fragment 关闭 UI
        RecordView.OnCloseListener listener = (RecordView.OnCloseListener) mFragmentList.get(POSITION_BODY);
        listener.onClose();
    }
    ...
    private void closeMakeup() {
        ...
        RecordView.OnCloseListener listener = (RecordView.OnCloseListener) mFragmentList.get(POSITION_MAKEUP);
        listener.onClose();
    }
